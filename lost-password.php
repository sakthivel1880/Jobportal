			...
			<section class="lost-ps-screen-sec">
				<div class="container">
                    ...
                    for($i=0;$row=mysqli_fetch_assoc($result);$i++){
						...
						<?php } ?>
						<form action="include/forgetpass.php" method="post">
							<input type="email" name="email" class="form-control" placeholder="Enter your Email" required>
							<button class="btn btn-login" type="submit" name="submit">Submit</button>
						</form>
...
<!-- Mirrored from codeminifier.com/updated-job-stock/job-stock/lost-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 May 2019 08:12:57 GMT -->
</html>