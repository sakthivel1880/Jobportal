      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="well form-horizontal" action="ads.php" method="post">
                      <fieldset>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 inputGroupContainer">
                               <div class="input-group"><input  id="submit" name="submit" placeholder="" class="form-control" required="true" value="submit" type="submit"></div>
                            </div>
                         </div>
                      </fieldset>
                   </form>
...
if(isset($_POST['submit'])){
  ...
  echo $sql = "INSERT INTO `ads_user`(`username`, `phone`, `address`, `company`, `wallet`, `department`, `email`) VALUES ('$username','$phone','$address','$company','$wallet','$department','$email')"; 
  if (mysqli_query($conn, $sql)) {
    ?>
    <script>window.location = 'sample.php?phone=<?php echo $phone; ?>'</script>
    <?php
} else {
