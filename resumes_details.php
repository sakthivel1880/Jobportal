...
float:left;
            ...
            if(isset($_GET['resume_id']) && !empty($_GET['resume_id'])){
                ...
                $sql1="SELECT * from `profile` where pid='$resume_id'";
                  ...
                  $date=$row1['pcreate_date'];
                    ...
                    for($i=0; $row3=mysqli_fetch_assoc($result3); $i++){
						 ...
						 $ctname=$row3['ctname'];
                            ...
                            $sql4="SELECT * from `profile_educ` where edu_rpid=$id ";
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-8">
							...
							<div class="row-bottom">
								...
								<?php
								 $sql2="SELECT * FROM `profile_exp` WHERE exp_rpid=$id ";
                            ...
                            <div class="row-bottom">
								...
								<?php
							$sql="SELECT * from `profile_skills` where skills_rpid=$id ";
